...
function beginCountUp(data) {
    (new CountUp("total", 0, data.total_money/10000000000, 2, 2.5)).start();
    (new CountUp("yes_today", 0, Math.round(data.total_money_yestday/1000000), 0, 2.5)).start();
    (new CountUp("user_num", 0, data.user_count.data, 0, 2.5)).start();
}
...
//     var element = $('#foc')
//     var tpl = element.find('script').html()
//     element.html(tmpl(tpl,INIT_DATA))
